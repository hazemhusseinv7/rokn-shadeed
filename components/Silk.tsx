...
void main() {
  ...
  vec4 col = vec4(uColor, 1.0) + vec4(pattern - 0.8) * 0.5 - rnd / 10.0 * uNoiseIntensity;
  col.a = 1.0;
  gl_FragColor = col;
}
`;
  ...
  return (
    <mesh ref={ref}>
      ...
      <shaderMaterial
        ...
        fragmentShader={isDarkMode ? fragmentShaderDark : fragmentShaderLight}
...
const Silk: React.FC<SilkProps> = ({
  ...
  const currentTheme = React.useMemo(() => {
    ...
    return initialTheme;
  }, [resolvedTheme, theme, initialTheme]);

  const isDarkMode = currentTheme === "dark";
  const color = isDarkMode ? "#003049" : "#fdf0d5";
  ...
  return (
    <Canvas dpr={[1, 2]} frameloop="always">
      <SilkPlane ref={meshRef} uniforms={uniforms} isDarkMode={isDarkMode} />
    </Canvas>
  );
};
