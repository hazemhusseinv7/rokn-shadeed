...
const BotDetection = ({
  ...
  return (
    ...
    >
      <div className="absolute left-1/2 h-full max-w-[300px] min-w-[300px] -translate-x-1/2">
        <div className="relative h-[80%] w-full">
          <motion.div
            className="pointer-events-none absolute bottom-5 left-[148px] h-[250px] w-[250px] origin-bottom-left"
            style={{
              background:
          ...
          <div className="absolute top-[100px] left-1/2 h-full w-[110%] -translate-x-1/2 rounded-full border-t border-dashed border-neutral-700/80" />
          <div className="absolute top-[152px] left-1/2 h-full w-full -translate-x-1/2 rounded-full border-t border-dashed border-neutral-700/80" />
          <div className="absolute top-[204px] left-1/2 h-full w-[80%] -translate-x-1/2 rounded-full border-t border-dashed border-neutral-700/80" />
          ...
          <Link
            href="/"
            className="absolute bottom-2 left-1/2 flex h-28 w-28 -translate-x-1/2 rotate-180 items-center justify-center rounded-full border border-neutral-800 bg-zinc-900"
          >
            <Image
